...
from ds_rdma_basic import rdma_basic_multiprocessing
from ds_rdma_handle import rdma_handle_multiprocessing
from test_ds_rdma_utils import refine_args
...
def main():
    ...
    multiprocess_function = rdma_handle_multiprocessing if args.handle else rdma_basic_multiprocessing
    if args.read_file:
